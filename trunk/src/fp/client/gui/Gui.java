...
public class Gui extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        messagePanelTextArea = new javax.swing.JTextArea();
        ...
        invitationPanel1 = new javax.swing.JPanel();
        ...
        weekChooserDialog = new javax.swing.JDialog();
        ...
        messagePanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("message.getTitle() + dateToString(message.getDate())"));
        ...
        messagePanelTimeRoomAvailability.setText("message.getTime() + message.getRoom() + checkAvailaility()");

        messagePanelTextArea.setColumns(20);
        messagePanelTextArea.setEditable(false);
        messagePanelTextArea.setLineWrap(true);
        messagePanelTextArea.setRows(5);
        messagePanelTextArea.setWrapStyleWord(true);
        messagePanelTextSP.setViewportView(messagePanelTextArea);
        ...
        messagePanelLayout.setHorizontalGroup(
            ...
            .addGroup(messagePanelLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(messagePanelListSP, javax.swing.GroupLayout.PREFERRED_SIZE, 137, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
        ...
        messagePanelLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, messagePanelLayout.createSequentialGroup()
                ...
                .addGroup(messagePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(messagePanel1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(messagePanelListSP, javax.swing.GroupLayout.DEFAULT_SIZE, 200, Short.MAX_VALUE))
                .addContainerGap())
        );

        messageOverviewTabbedPane.addTab("Meldinger + antallUlest", messagePanel);
        ...
        invitationPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("message.getTitle() + dateToString(message.getDate())"));
        ...
        invitationPanelTimeRoomAvailability.setText("message.getTime() + message.getRoom() + checkAvailaility()");
        ...
        invitationPanelTextSP.setViewportView(jTextArea3);

        javax.swing.GroupLayout invitationPanel1Layout = new javax.swing.GroupLayout(invitationPanel1);
        invitationPanel1.setLayout(invitationPanel1Layout);
        invitationPanel1Layout.setHorizontalGroup(
            invitationPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(invitationPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addGroup(invitationPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
        ...
        invitationPanel1Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {invitationPanelAttendingButton, invitationPanelCloseButton, invitationPanelNotAttendinButton});

        invitationPanel1Layout.setVerticalGroup(
            invitationPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, invitationPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(invitationPanelTimeRoomAvailability)
                .addGap(18, 18, 18)
                .addComponent(invitationPanelTextSP)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(invitationPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(invitationPanelNotAttendinButton)
                    .addComponent(invitationPanelAttendingButton)
                    .addComponent(invitationPanelCloseButton)))
        );
        ...
        invitationPanelLayout.setHorizontalGroup(
            ...
            .addGroup(invitationPanelLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(invitationPanelListSP, javax.swing.GroupLayout.PREFERRED_SIZE, 137, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(invitationPanel1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        invitationPanelLayout.setVerticalGroup(
            ...
            .addGroup(invitationPanelLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(invitationPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addComponent(invitationPanelListSP, javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(invitationPanel1, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );

        messageOverviewTabbedPane.addTab("Innkallinger + antallUlest", invitationPanel);
        ...
        messageOverviewDialogLayout.setHorizontalGroup(
            ...
            .addComponent(messageOverviewTabbedPane, javax.swing.GroupLayout.DEFAULT_SIZE, 565, Short.MAX_VALUE)
        );
        ...
        newAppointmentEndTimeCB.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "00:00", "00:15", "00:30", "00:45", "01:00", "01:15", "01:30", "01:45", "02:00", "02:15", "02:30", "02:45", "03:00", "03:15", "03:30", "03:45", "04:00", "04:15", "04:30", "04:45", "05:00", "05:15", "05:30", "05:45", "06:00", "06:15", "06:30", "06:45", "07:00", "07:15", "07:30", "07:45", "08:00", "08:15", "08:30", "08:45", "09:00", "09:15", "09:30", "09:45", "10:00", "10:15", "10:30", "10:45", "11:00", "11:15", "11:30", "11:45", "12:00", "12:15", "12:30", "12:45", "13:00", "13:15", "13:30", "13:45", "14:00", "14:15", "14:30", "14:45", "15:00", "15:15", "15:30", "15:45", "16:00", "16:15", "16:30", "16:45", "17:00", "17:15", "17:30", "17:45", "18:00", "18:15", "18:30", "18:45", "19:00", "19:15", "19:30", "19:45", "20:00", "20:15", "20:30", "20:45", "21:00", "21:15", "21:30", "21:45", "22:00", "22:15", "22:30", "22:45", "23:00", "23:15", "23:30", "23:45" }));

        newAppointmentRoomCB.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        ...
        weekChooserDialog.setTitle("Velg Uke");
        weekChooserDialog.setModal(true);
        weekChooserDialog.setResizable(false);

        javax.swing.GroupLayout weekChooserDialogLayout = new javax.swing.GroupLayout(weekChooserDialog.getContentPane());
        weekChooserDialog.getContentPane().setLayout(weekChooserDialogLayout);
        weekChooserDialogLayout.setHorizontalGroup(
            weekChooserDialogLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 380, Short.MAX_VALUE)
        );
        weekChooserDialogLayout.setVerticalGroup(
            weekChooserDialogLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    */
    ...
    private javax.swing.JPanel invitationPanel1;
    ...
    private javax.swing.JTextArea messagePanelTextArea;
    ...
    private javax.swing.JDialog weekChooserDialog;
