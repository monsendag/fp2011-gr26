...
public class DateChooserPanel extends JPanel implements ActionListener {
    ...
    private JPanel constructSelectionPanel() {
        ...
        for(int i=0;i<months.length;i++){
        	switch(i){
        	case 0: months[0] = "Januar"; break;
        	case 1: months[1] = "Februar"; break;
        	case 2: months[2] = "Mars"; break;
        	case 3: months[3] = "April"; break;
        	case 4: months[4] = "Mai"; break;
        	case 5: months[5] = "Juni"; break;
        	case 6: months[6] = "Juli"; break;
        	case 7: months[7] = "August"; break;
        	case 8: months[8] = "Setpember"; break;
        	case 9: months[9] = "Oktober"; break;
        	case 10: months[10] = "November"; break;
        	case 11: months[11] = "Desember"; break;
